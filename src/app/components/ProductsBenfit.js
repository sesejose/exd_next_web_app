        ...
        <div id="products-ready">
            <div className="grid-center">
                <div className="flex-column-center col-4-10">
                    ...
                    <h4 className="zero ptb">Ready to transform?</h4>
                    <div className="text-1 ptb text-center">Explore the transformative potential of our Digital Platforms and embark on a journey to revolutionize your workplace.</div>
