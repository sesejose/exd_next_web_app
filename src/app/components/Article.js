...
export default function Article({ id, category, title, image, excerpt, bodyHeadline, bodyImage, bodyCaption, bodyText, bodyQuote, bodyMoreText, bodyLinkText, bodyLink, bodyEmailText, bodyEmail, slug }) {
