      ...
      <div id="solution-ex-clarification">
        ...
        <div className="grid">
          <div className="col-1-4">
              <h4>Employee Experience clarification</h4>
          </div>
          <div className="col-6-13">
            <div className="text-1">In the realm of Enterprise Service Management, or as we call it, Employee Service Management, we focus on the delivery of tangible, intangible, or combined products that enrich your work life. From salary inquiries to acquiring a new laptop or seeking assistance in hiring, our solutions aim to streamline the entire interaction or friction points before, during, and after product delivery.</div>
          </div>
        </div>
